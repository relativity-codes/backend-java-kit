package com.elwalkre.commerce_maven.auth.service;
...
import com.elwalkre.commerce_maven.mailing.dto.EmailRequest;
import com.elwalkre.commerce_maven.mailing.service.EmailService;
import com.elwalkre.commerce_maven.user.entity.User;
import com.elwalkre.commerce_maven.user.repository.UserRepository;
...
public class AuthService implements UserDetailsService {
    ...
    public void resetPassword(String token, String newPassword) throws Exception {
        try {
            ...
            throw new Exception("Invalid or expired reset password token: " + Arrays.toString(e.getStackTrace()));
        }
    }
    ...
    public void changePassword(UUID userId, String oldPassword, String newPassword) throws Exception {
        try {
            ...
            throw new Exception("Invalid or incorrect old password: " + Arrays.toString(e.getStackTrace()));
        }
    }
